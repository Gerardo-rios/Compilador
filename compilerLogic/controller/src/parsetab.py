...
_lr_productions = [
  ...
  ('program -> block','program',1,'p_program','analizadorSintactico.py',29),
  ('block -> constDecl varDecl procDecl statement','block',4,'p_block','analizadorSintactico.py',34),
  ('constDecl -> CONST constAssignmentList SEMMICOLOM','constDecl',3,'p_constDecl','analizadorSintactico.py',39),
  ('constDecl -> empty','constDecl',1,'p_constDeclEmpty','analizadorSintactico.py',44),
  ('constAssignmentList -> ID ASSIGN NUMBER','constAssignmentList',3,'p_constAssignmentList1','analizadorSintactico.py',49),
  ('constAssignmentList -> constAssignmentList COMMA ID ASSIGN NUMBER','constAssignmentList',5,'p_constAssignmentList2','analizadorSintactico.py',54),
  ('varDecl -> VAR identList SEMMICOLOM','varDecl',3,'p_varDecl1','analizadorSintactico.py',59),
  ('varDecl -> empty','varDecl',1,'p_varDeclEmpty','analizadorSintactico.py',64),
  ('identList -> ID','identList',1,'p_identList1','analizadorSintactico.py',69),
  ('identList -> identList COMMA ID','identList',3,'p_identList2','analizadorSintactico.py',74),
  ('procDecl -> procDecl PROCEDURE ID SEMMICOLOM block SEMMICOLOM','procDecl',6,'p_procDecl1','analizadorSintactico.py',79),
  ('procDecl -> empty','procDecl',1,'p_procDeclEmpty','analizadorSintactico.py',84),
  ('statement -> ID UPDATE expression','statement',3,'p_statement1','analizadorSintactico.py',89),
  ('statement -> CALL ID','statement',2,'p_statement2','analizadorSintactico.py',94),
  ('statement -> BEGIN statementList END','statement',3,'p_statement3','analizadorSintactico.py',99),
  ('statement -> IF condition THEN statement','statement',4,'p_statement4','analizadorSintactico.py',104),
  ('statement -> WHILE condition DO statement','statement',4,'p_statement5','analizadorSintactico.py',109),
  ('statement -> empty','statement',1,'p_statementEmpty','analizadorSintactico.py',114),
  ('statementList -> statement','statementList',1,'p_statementList1','analizadorSintactico.py',119),
  ('statementList -> statementList SEMMICOLOM statement','statementList',3,'p_statementList2','analizadorSintactico.py',124),
  ('condition -> ODD expression','condition',2,'p_condition1','analizadorSintactico.py',129),
  ('condition -> expression relation expression','condition',3,'p_condition2','analizadorSintactico.py',134),
  ('relation -> ASSIGN','relation',1,'p_relation1','analizadorSintactico.py',139),
  ('relation -> NE','relation',1,'p_relation2','analizadorSintactico.py',144),
  ('relation -> LT','relation',1,'p_relation3','analizadorSintactico.py',149),
  ('relation -> GT','relation',1,'p_relation4','analizadorSintactico.py',154),
  ('relation -> LTE','relation',1,'p_relation5','analizadorSintactico.py',159),
  ('relation -> GTE','relation',1,'p_relation6','analizadorSintactico.py',164),
  ('expression -> term','expression',1,'p_expression1','analizadorSintactico.py',169),
  ('expression -> addingOperator term','expression',2,'p_expression2','analizadorSintactico.py',174),
  ('expression -> expression addingOperator term','expression',3,'p_expression3','analizadorSintactico.py',179),
  ('addingOperator -> PLUS','addingOperator',1,'p_addingOperator1','analizadorSintactico.py',184),
  ('addingOperator -> MINUS','addingOperator',1,'p_addingOperator2','analizadorSintactico.py',189),
  ('term -> factor','term',1,'p_term1','analizadorSintactico.py',194),
  ('term -> term multiplyingOperator factor','term',3,'p_term2','analizadorSintactico.py',199),
  ('multiplyingOperator -> TIMES','multiplyingOperator',1,'p_multiplyingOperator1','analizadorSintactico.py',204),
  ('multiplyingOperator -> DIVIDE','multiplyingOperator',1,'p_multiplyingOperator2','analizadorSintactico.py',209),
  ('factor -> ID','factor',1,'p_factor1','analizadorSintactico.py',214),
  ('factor -> NUMBER','factor',1,'p_factor2','analizadorSintactico.py',219),
  ('factor -> LPARENT expression RPARENT','factor',3,'p_factor3','analizadorSintactico.py',224),
  ('empty -> <empty>','empty',0,'p_empty','analizadorSintactico.py',229),
]
